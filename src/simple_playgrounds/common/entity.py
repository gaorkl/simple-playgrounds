...
class EmbodiedEntity(Entity, ABC):
    """
    EmbodiedEntity creates a physical object, and deals with interactive properties and visual appearance.
    EmbodiedEntity have a physical body on which shapes can be attached.
    An agent is composed of multiple EmbodiedEntity that are attached to each other.
    """
