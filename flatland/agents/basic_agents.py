...
from .body_parts.parts import BodyBase, Head, Eye, Arm
...
class BaseAgent(Agent):
    ...
    def __init__(self, initial_position, **kwargs):
        ...
        base_agent = BodyBase(name = 'base', can_eat=True, can_grasp=True, can_activate=True, radius = 10)
...
class HeadEyeAgent(Agent):
    ...
    def key_mapping(self):
        ...
        keys.append(Keymap(self.eye_l.name, ActionTypes.ANGULAR_VELOCITY, K_g, KeyTypes.PRESS_HOLD, -1))
        keys.append(Keymap(self.eye_l.name, ActionTypes.ANGULAR_VELOCITY, K_h, KeyTypes.PRESS_HOLD, 1))

        keys.append(Keymap(self.eye_r.name, ActionTypes.ANGULAR_VELOCITY, K_j, KeyTypes.PRESS_HOLD, -1))
