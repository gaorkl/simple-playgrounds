...
class GrasperMixin(ActionMixin, ABC):
    ...
    def __init__(self, max_grasped=None):
        self.grasped: Dict[GraspableMixin, List[pymunk.PinJoint]] = {}
        self.max_grasped = max_grasped
...
class GrasperHold(GrasperMixin):
    def __init__(self, max_grasped=None):
        super().__init__(max_grasped=max_grasped)
