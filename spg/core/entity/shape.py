...
class ShapeMixin:
    ...
    def __init__(
        ...
        **_,
        ...
        Args:
            traversable: bool,
                if True, the entity can't be observed and has no physical collisions
            shape_approximation: Optional[str],
                shape approximation to use for the entity, can be "circle", "box", "hull", "decomposition"
            **_:
        """
