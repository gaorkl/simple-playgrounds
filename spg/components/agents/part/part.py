...
of an agents. Parts are visible and movable by default.

Examples on how to add Parts to an agents can be found
...
# from ...base.entity import PhysicalEntity
...
#             assert elem.name not in self.agents.parts
