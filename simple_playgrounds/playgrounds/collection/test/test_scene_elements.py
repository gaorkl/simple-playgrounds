...
class Graspables(SingleRoom):
    ...
    def __init__(self, size=(200, 200), **playground_params):
        ...
        square_01 = Basic([150, 60, math.pi/4], default_config_key='square',
                          graspable=True, mass=10)
        self.add_scene_element(square_01)
        ...
        hexagon_01 = Basic([100, 100, 0], default_config_key='hexagon',
                           graspable=True, mass=10)
        self.add_scene_element(hexagon_01)
...
class Contacts(SingleRoom):
    ...
    def __init__(self, size=(200, 200), **playground_params):
        ...
        poison_area = PositionAreaSampler(area_shape='rectangle',
                                          center=[100, 150], width_length=[20, 20])
        for _ in range(5):
            poison = Poison(poison_area)
            self.add_scene_element(poison)

        candy_area = PositionAreaSampler(area_shape='rectangle',
        ...
        # outside on purpose
        outside_area = PositionAreaSampler(area_shape='rectangle',
...
class Interactives(SingleRoom):
    ...
    def __init__(self, size=(300, 300), **playground_params):
        ...
        key_chest = Key([50, 200, 0], default_config_key='pentagon',
...
class Conditioning(SingleRoom):
    ...
    def __init__(self, size=(300, 300), **playground_params):
        ...
        light_01 = ConditionedColorChanging([150, 100, 0],
                                            conditioned_entity=lever,
                                            timers=[100, 100],
...
class Fields(SingleRoom):
    ...
    def __init__(self, size=(200, 200), **playground_params):
        ...
        area_2 = PositionAreaSampler(area_shape='rectangle',
