...
class EndgoalRoomCue(SingleRoom):
    ...
    def __init__(self):
        ...
        # Obstacles
        obstacle_1 = Basic((60, 30, 0.34),
                           default_config_key='pentagon', radius=9)
        self.add_scene_element(obstacle_1)

        obstacle_2 = Basic((130, 150, 1.7),
                           default_config_key='rectangle', width_length=[8, 12])
        self.add_scene_element(obstacle_2)

        obstacle_3 = Basic((40, 140, 0.4),
                           default_config_key='square', radius=8)
        self.add_scene_element(obstacle_3)

        obstacle_4 = Basic((160, 60, 0),
                           physical_shape='triangle', radius=14, texture=(150, 200, 200))
    ...
    def _set_goal(self):
        ...
        self.cue = Basic((100, 100, 0),
                         physical_shape='circle', radius=10, texture=col, is_temporary_entity=True)
...
class DispenserEnv(ConnectedRooms2D):
    ...
    def _assign_areas(self):
        ...
        area_prod = PositionAreaSampler(center=prod_center,
                                        area_shape='rectangle', width_length=prod_shape)
        area_dispenser = PositionAreaSampler(center=dispenser_center,
    ...
    def _place_scene_elements(self):
        ...
        self.dispenser = Dispenser(self.area_dispenser,
                                   production_area=self.area_prod, entity_produced=Candy,
...
class CoinMaster(SingleRoom):
    ...
    def __init__(self):
        ...
        self.vending_machine = VendingMachine(self.area_vending, allow_overlapping=False, reward=1)
    ...
    def _assign_areas():
        ...
        area_vm = PositionAreaSampler(center=vm_center, area_shape='rectangle',
                                      width_length=[80, 80])
