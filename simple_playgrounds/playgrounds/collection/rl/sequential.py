...
class DoorDispenserCoin(GridRooms):
    ...
    def __init__(self,
        ...
        area_key = CoordinateSampler(center=area_key_center,
                                       area_shape='rectangle', width_length=area_key_shape)
        ...
        area_vm = CoordinateSampler(center=vm_center,
                                           area_shape='rectangle', width_length=vm_shape)
        ...
        dispenser = Dispenser(Coin, production_area=area_prod, entity_produced_params={'graspable': True,
                                                                                       'vending_machine': vm})
        self.add_scene_element(dispenser, area_dispenser, allow_overlapping=False)
